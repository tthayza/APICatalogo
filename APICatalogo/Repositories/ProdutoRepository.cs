...
namespace APICatalogo.Repositories
{
    public class ProdutoRepository : Repository<Produto>, IProdutoRepository
    {
        ...
        public async Task<IPagedList<Produto>> GetProdutosAsync(ProdutosParameters produtosParams)
        {
            ...
            //var resultadoProdutos = PagedList<Produto>.ToPagedList(produtosOrdenados, produtosParams.PageNumber, produtosParams.PageSize);
            
            var resultadoProdutos = await produtosOrdenados.ToPagedListAsync(produtosParams.PageNumber,
        ...
        {
            var produtosPorCategorias = await GetAllAsync();
            return produtosPorCategorias.Where(c => c.CategoriaId == id);
        }
    }
}
